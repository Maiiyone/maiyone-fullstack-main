  ...
  return (
    <div className="p-8 w-[100%]">
      ...
      <p className="text-center text-sm">
        ...
        tại
        <span className="font-bold"> Maiyone.me </span>
      </p>
      <div className="flex justify-center my-8">
        <p className="text-center text-sm w-[70%] ">
          Đơn hàng của bạn CHẮC CHẮN đã được chuyển tới hệ thống xử lý đơn hàng
          của Maiyone. Trong quá trình xử lý Maiyone sẽ liên hệ lại nếu như
          cần thêm thông tin từ bạn. Ngoài ra Maiyone cũng sẽ có gửi xác nhận
          đơn hàng bằng Email và tin nhắn
        </p>
      </div>
      <p className="text-center text-sm">
        Tham gia cộng đồng{" "}
        <span className="font-bold"> Mặc Đẹp Sống Chất </span> cùng Maiyone.
      </p>
