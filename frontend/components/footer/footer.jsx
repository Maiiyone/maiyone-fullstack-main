    ...
    <div className="bg-black text-white">
      <div className="flex flex-row justify-between items-center p-8">
        <div className="w-[380px]">
          <span className="font-bold text-xl">Maiyonelắng nghe bạn!</span>{' '}
          <br></br>
        ...
        <div>
          ...
          <div className="flex flex-row items-center my-4">
            <img
              ...
              alt="icon"
            />
            <p className="font-bold ml-4 cursor-pointer">maiyone.com</p>
          </div>
        </div>
        <div className="flex flex-row items-center">
          <img
      ...
      <div className="flex flex-row justify-between p-8">
        ...
        <div>
          ...
          <p className="font-bold my-4">VỀ Maiyone</p>
          <p className="text-[12px] my-4">Maiyone101</p>
          <p className="text-[12px] my-4 hover:text-yellow-500 cursor-pointer">
            DVKH xuất sắc
          </p>
          <p className="text-[12px] my-4 hover:text-yellow-500 cursor-pointer">
            Câu chuyện về Maiyone
          </p>
          <p className="text-[12px] my-4 hover:text-yellow-500 cursor-pointer">
            Nhà máy
          </p>
